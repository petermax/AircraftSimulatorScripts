...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
		...
		public Text Text_altitude;
		public Text Text_ForwardSpeed;
		public Text Text_EnginePower;


        private void Start()
        {
			Debug.Log ("plane scripts added to " + gameObject.name);
			Text_altitude.text = "Altitude: " + Altitude;
        ...
        private void CalculateForwardSpeed()
        {
			...
			Text_ForwardSpeed.text = "Speed: " + ForwardSpeed;
        }
        ...
        private void ControlThrottle()
        {
			...
			Text_EnginePower.text = "Engine Power: " + EnginePower;
        }
